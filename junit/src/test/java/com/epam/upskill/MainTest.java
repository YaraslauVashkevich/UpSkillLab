...
public class MainTest {
    ...
    public void equationsShouldHaveOneZerroInCoefficientBSquareXPositive() {
        expected.add(1.5); // X1
        expected.add(-1.5); // X2
        actual = Main.equation(4, 0, -9); // (a, b, c)
        Assert.assertEquals(expected, actual);
    }
}
